...
export default {
    ...
    <!-- Desktop: original single-row header (md and up) -->
        <div class="offcanvas-header th-header-upper d-md-flex justify-content-between align-items-center">
            <div class="position-absolute top-30 right-15 d-xl-none">
                <button type="button" data-bs-dismiss="offcanvas" aria-label="Close Virtual Pinboard" class="btn btn-link p-1 border-0 text-body pinboard-offcanvas-close flex-shrink-0">
                    <i aria-hidden="true" class="fa-solid fa-xmark fa-lg"></i>
                </button>
            </div>

            <div class="pinboard-header-layout w-100">
                <div class="d-flex align-items-center pinboard-header-title">
                    <div class="offcanvas-header th-header-lower">
                        <h5 id="offcanvasRightLabel2">Virtual Pinboard</h5>
                    </div> 
                </div>
                <div class="d-flex align-items-start pinboard-header-info"
        ...
        <div class="offcanvas-body">
            <div class="th-pinboard th-pinboard--tablet-split">
                <div class="mb-20 pb-0 pinboard-offcanvas-search"
                    v-show="loggedInUser && loggedInUser.email">
                ...
                <div
                    class="row gx-0 gx-md-3 gx-lg-0 gy-0 align-items-md-stretch align-items-lg-start mx-0 pinboard-offcanvas-tablet-row gap-3">
                    <div class="col-12 th-col-lg-4 px-0 pinboard-offcanvas-col pinboard-offcanvas-col--main">
                        ...
                        <div id="pinboard-items" class="th-pinboard-upper th-ofc-pinboard-item-upper pinboard-items-scroll">
                            ...
                            <draggable v-if="!loading('getPinboard') && Array.isArray(items)" v-model="items"
                                ...
                                <h5 class="pinboard-project-photos-title d-block">
                                    Product List
                                </h5>


                                <transition-group>
                                    <div v-for="(item, index) in items" :key="getKey(item, index)" class="row th-pinboard-item">
                            ...
                            <div class="th-pinboard-bottom d-block">
                                <button
                                    v-show="loggedInUser"
                                    v-if="!showAddComment"
                                    type="button"
                                    class="th-add-comment-toggle-btn th-add-comment-toggle-btn-lg"
                    ...
                    <div class="col-12 th-col-lg-8 px-0 pinboard-offcanvas-col pinboard-offcanvas-col--actions">
                        <div class="pinboard-project-photos">
                            <h5 class="pinboard-project-photos-title">
                                Project Photos
                                <span>(taken on iPad camera)</span>
                            </h5>
                            <div class="pinboard-project-photos-grid">
                                <div class="pinboard-project-photos-item">
                                    <img src="/img/pinboard/pinboard img 1.png" alt="Project photo 1" />
                                </div>
                                <div class="pinboard-project-photos-item">
                                    <img src="/img/pinboard/pinboard img 2.png" alt="Project photo 2" />
                                </div>
                                <div class="pinboard-project-photos-item">
                                    <img src="/img/pinboard/pinboard img 3.png" alt="Project photo 3" />
                                </div>
                                <div class="pinboard-project-photos-item">
                                    <img src="/img/pinboard/pinboard img 1.png" alt="Project photo 4" />
                                </div>
                                <div class="pinboard-project-photos-item">
                                    <img src="/img/pinboard/pinboard img 1.png" alt="Project photo 1" />
                                </div>
                                    ...
                                    <div class="d-flex flex-column gap-25 pinboard-offcanvas-footer-btns" v-if="loggedInUser">
                                        <div class="d-flex flex-row gap-20">
                                            <button
                                                ...
                                                v-if="!showAddComment"
                                                type="button"
                                                class="th-add-comment-toggle-btn d-none d-lg-block th-add-comment-toggle-btn-lg"
                                                @click.prevent="showAddComment = true"
                                            >
                                                <span class="th-add-comment-toggle-plus">+</span>
                                                <span class="th-add-comment-toggle-text">Add Comment</span>
