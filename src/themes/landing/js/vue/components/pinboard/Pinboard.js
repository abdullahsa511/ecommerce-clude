...
import BookingCallRequestModal from './BookingCallRequestModal.js';
import BookingConfirmationModal from './BookingConfirmation.js';
import ProjectSubmissionModal from './ProjectSubmissionModal.js';
...
export default {
    ...
    computed: {
        ...
        projectItemCount() {
            const pinboardItems = this.pinboard?.pinboard_items;
            if (Array.isArray(pinboardItems)) return pinboardItems.length;
    ...
    methods: {
        ...
        closeModal() {
            ...
            this.projectSubmissionType = 'email';
        ...
        handleProjectSubmissionPopUp(type = 'email') {
    ...
    <div class="bg-gray pinboard-app-root">
        ...
        <div class="offcanvas-body">
            <div class="th-pinboard th-pinboard--tablet-split">
                <div
                                                        ...
                                                        <div class="card-content">
                                                            <div class="card-header">
                                                                <div>
                                                                    ...
                                                                    <p class="type">{{ item.model_type === 'images' ? 'Image' : item.model_type | capitalize }}</p>
                                                                </div>
                    ...
                    <div class="col-12 col-lg-12 pinboard-offcanvas-col pinboard-offcanvas-col--actions position-absolute bottom-0" style="right: 0;">
                            ...
                            <div id="th-pinboard-guest" class="">
                                ...
                                <div v-if="loggedInUser">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pinboard-offcanvas-footer-icons" v-if="isMobile">
                                        ...
                                        <!-- Manage Pinboard -->
                                        <a href="/account/virtual-pinboards" class="icon-btn">
        ...
        <communication-modal
            v-if="showProjectModal && customer?.is_verified && !showBookingModal && !showBookingCallRequestModal && !showProjectSubmissionModal"
            :customer="customer"
            :pinboard-title="pinboard.job_title"
        ...
        <project-submission-modal
            v-if="showProjectModal && customer?.is_verified && showProjectSubmissionModal"
            :customer="customer"
            :pinboard-title="pinboard.job_title"
            :pinboard-item-count="projectItemCount"
            :pinboard-id="pinboard.pinboard_id || pinboard.pinboard_temp_id"
            :pinboard-uuid="pinboard.uuid"
            :logged-in-user="loggedInUser"
            :show-booking-modal="showBookingModal"
            ...
            page="virtual_pinboard"
        ></project-submission-modal>

        <booking-call-request-modal
            v-if="showProjectModal && customer?.is_verified && showBookingCallRequestModal"
            :pinboard-title="pinboard.job_title"
            :pinboard-id="pinboard.pinboard_id || pinboard.pinboard_temp_id"
            :pinboard-uuid="pinboard.uuid"
            :logged-in-user="loggedInUser"
        ...
        <booking-confirmation-modal
            v-if="showProjectModal && customer?.is_verified && showBookingConfirmationModal"
            :pinboard-title="pinboard.job_title"
            :pinboard-id="pinboard.pinboard_id || pinboard.pinboard_temp_id"
            :pinboard-uuid="pinboard.uuid"
            :logged-in-user="loggedInUser"
