...
class Productstorymasonry extends ComponentBase {
    ...
    function results($params = []) {
        ...
        $component = $this->componentRepository->getComponentByName('productstorymasonry');
        $results = [];
        ...
        $results = $this->productRepository->getProductStoryMasonryComponentData($params);
