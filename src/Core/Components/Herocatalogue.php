...
class Herocatalogue extends ComponentBase {
    ...
    function results() {
        ...
        // $results['hero_title'] = "Catalogue";
        // $results['hero_subtitle'] = "Lorem ipsum dolor sit amet consectetur. Scelerisque urna pellentesque.";
        ...
        $component = $this->componentRepository->getComponentByName('herocatalogue');
        // echo '<pre>';
        // print_r($component);
        // echo '</pre>';
        // exit;
        ...
        if (isset($component->image) && is_array($component->image) && count($component->image) > 0 && isset($component->image[0]) && is_array($component->image[0])) {
            ...
            if (isset($imageData['objectURL'])) {
                $results['bg_image'] = $imageData['objectURL'];
            } else {
                $results['bg_image'] = '';
            }
        }
