...
class Productspecifications extends ComponentBase
{
    ...
    function results($params = []) {
        ...
        $component = $this->componentRepository->getComponentByName('productspecifications');
        // $results = [];
        ...
        $results = $this->productRepository->getProductSpecificationsComponentData($params);
        $results['title'] = $component->items[0]['title'];

        // $results['dimensions'] = $results['dimensions'];
        return $results;
    }
