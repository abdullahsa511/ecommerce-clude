...
class Designresourceimages extends ComponentBase {
    ...
    function results($params = []) {        
        $component = $this->componentRepository->getComponentByName('designresourceimages');
        ...
        $results = $this->designResourceRepository->getDesignResourceImagesComponentData($params);
