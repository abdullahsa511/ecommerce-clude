...
class Productmedia extends ComponentBase
{
    ...
    function results($params = []) {
        ...
        $component = $this->componentRepository->getComponentByName('productmedia');
        // $results = [];
        ...
        $results = $this->productRepository->getProductVideoGallaryImagesData($params);
        return $results;
    }
