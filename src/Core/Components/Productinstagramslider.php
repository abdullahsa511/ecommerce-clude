...
class Productinstagramslider extends ComponentBase {
    ...
    function results($params = []) {
        $component = $this->componentRepository->getComponentByName('productinstagramslider');
        $results = [];
        ...
        $results = $this->productRepository->getProductInstagramSliderComponentData($params['slug']);
