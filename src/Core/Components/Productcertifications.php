...
class Productcertifications extends ComponentBase
{
    ...
    function results($params = []) {
        ...
        $component = $this->componentRepository->getComponentByName('productcertifications');
        // $results = [];
        ...
        $params['resource_type'] = 'documents';
        list($component) = Event::trigger(__CLASS__,__FUNCTION__, $component);
        $component->options = $this->options;

        $results = $this->productRepository->getProductCertificationsTabData($params);
