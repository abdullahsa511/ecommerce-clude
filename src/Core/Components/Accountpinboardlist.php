...
class Accountpinboardlist extends ComponentBase {
    ...
    function results($params = []) {
        $results = [];
        $component = $this->componentRepository->getComponentByName('accountpinboardlist');
        ...
        // $results = $this->pinboardRepository->getPinboardListComponentData($params); 
        // echo '<pre>';
        // print_r($results);
        // echo '</pre>';
        
        $results['component_link'] = env('APP_ADMIN_URL')."/components/{$component->component_id}/items";
        $results['pinboard_details_link'] = env('APP_URL')."/account/virtual-pinboards/";
        $results['options'] = $this->options;
        $results['title'] = "Pinboard List";
        $results['success'] = isset($params['success']) && $params['success'] ? true : false;
        $results['message'] = isset($params['message']) ? $params['message'] : '';
        return $results;
    }
}
