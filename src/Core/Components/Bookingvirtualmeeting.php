...
class Bookingvirtualmeeting extends ComponentBase {
    ...
    function results($params = []) {
        ...
        $pinboard = $this->pinboardRepository->getPinboardFinalBookingComponent($params['uuid'], 'virtual_meeting');
        $results['pinboard'] = $pinboard;
        return $results;
    }
}
