...
class Featureprojectsmasonry extends ComponentBase {
    ...
    function results($params = []) {
        $component = $this->componentRepository->getComponentByName('featureprojectsmasonry');
        ...
        $results = $this->projectRepository->getFeaturedProjectMasonryComponentData($params);
