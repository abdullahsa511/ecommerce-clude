...
class Explorevirtually extends ComponentBase {
    ...
    function results($params = []) {
        // $results = [];
        // $results['section_title'] = 'Explore Virtually';
        // $results['section_subtitle'] = "Lorem ipsum dolor sit amet consectetur. Egestas orci gravida amet egestas et.";
        // $results['items'] = [
        //     [
        //         'image' => '/img/contact-us/explore-1.png',
        //         'title' => 'Sydney Showroom',
        //         'book_btn' => 'Book a Virtual Tour',
        //         'view_btn' => 'View Tour'
        //     ],
        //     [
        //         'image' => '/img/contact-us/explore-2.png',
        ...
        $component = $this->componentRepository->getComponentByName('explorevirtually');
        ...
        if (isset($component->items) && is_array($component->items)) {
            foreach ($component->items as $itemIndex => $item) {
                        ...
                        if (isset($field['name']) && isset($field['value'])) {
                            ...
                            switch ($fieldName) {
                                case 'title':
                                    ...
                                    break;
                                case 'book_btn':
                                    $itemData['book_btn'] = $fieldValue;
                                    break;
                                case 'view_btn':
                                    $itemData['view_btn'] = $fieldValue;
                                    break;
                                case 'book_link':
                                    $itemData['book_link'] = $fieldValue;
                                    break;
                                case 'view_link':
                                    $itemData['view_link'] = $fieldValue;
                                    break;
                                case 'image':
                ...
                if (isset($itemData['title']) && isset($itemData['book_btn']) && isset($itemData['view_btn']) && isset($itemData['image']) && isset($itemData['book_link']) && isset($itemData['view_link'])) {
