...
class Salesteamsydneys extends ComponentBase {
    ...
    function results($params = []) {
        $results = [];
        $component = $this->componentRepository->getComponentByName('salesteamsydneys');
        // $results['items'] = $this->componentRepository->getComponentItems($component);
        $results['items'] = $this->showroomRepository->getShowroomContactForComponent(1);
        ...
        $results['component_link'] = $config."/showroom-contact/list";
        return $results;
