...
class Projecthero extends ComponentBase {
    ...
    function results($params = []) {
        $results = [];
        $component = $this->componentRepository->getComponentByName('projecthero');
        ...
        $results['title'] = isset($component->section_title) ? $component->section_title : 'Projects';
        // subtitle
        $subtitle = isset($component->section_subtitle) ? $component->section_subtitle : '';
        $results['subtitle'] = $subtitle ? $subtitle : '';
      
        $results['image_banner'] = isset($component->image) && is_array($component->image) && isset($component->image[0]) && is_array($component->image[0]) ? $component->image[0]['objectURL'] : '';
   
        $buttons = isset($component->buttons) ? $component->buttons : [];
