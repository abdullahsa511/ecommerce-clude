...
interface AdminFailedLoginRepositoryInterface
{
     ...
     * @return AdminFailedLogin|null
     */
    public function logFailed(?int $admin_id = null, ?string $username = null, string $updated_at, string $last_ip): ?AdminFailedLogin;
     ...
     * 
     * @param array $admin_ids Array of admin IDs
     * @param string|null $updated_at Filter by update date
     * @param int|null $count Filter by count
     * @return bool
     */
    public function delete(array $admin_ids, ?string $updated_at = null, ?int $count = null): bool;
} 