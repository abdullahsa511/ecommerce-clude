...
use App\Core\Services\MicrosoftService;
...
class Microsoft extends AbstractProvider
{
     ...
     * @var array
     */
    public $defaultScopes = ['openid', 'profile', 'email', 'offline_access', 'User.Read'];

    /**
     * Microsoft expects scopes separated by spaces (not commas).
     *
     * @var string
     */
    ...
    {
        return new MicrosoftService($response);
    }
