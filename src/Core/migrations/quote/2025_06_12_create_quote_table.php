...
class CreateQuoteTable
{
    ...
    public function up(): void
    {
        $query = "
            CREATE TABLE IF NOT EXISTS `quote` (
                ...
                `quote_status_id` INT UNSIGNED NOT NULL DEFAULT 0,
        ...
        try {
            ...
            echo "Error creating table 'quote': " . $e->getMessage() . "\n";
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            $this->pdo->exec($query);
            echo "Table 'quote' dropped successfully.\n";
        } catch (PDOException $e) {
            echo "Error dropping table 'quote': " . $e->getMessage() . "\n";
        }
    }
} 