...
class CreateOrderTable
{
    ...
    /**
     * Run the migration to create the order table.
     */
    public function up(): void
    {
        $query = "
            CREATE TABLE IF NOT EXISTS `order` (
                ...
                `reference_number` varchar(64) NOT NULL DEFAULT '0',
        ...
        try {
            ...
            echo "Error creating table 'order': " . $e->getMessage() . "\n";
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            $this->pdo->exec($query);
            echo "Table 'order' dropped successfully.\n";
        } catch (PDOException $e) {
            echo "Error dropping table 'order': " . $e->getMessage() . "\n";
        }
    }
} 