...
class CreateOrderItemsTable
{
    ...
    public function up(): void
    {
        $query = "
            CREATE TABLE IF NOT EXISTS `order_items` (
                ...
                PRIMARY KEY (`order_item_id`,`language_id`),
        ...
        try {
            ...
            echo "Error creating table 'order_items': " . $e->getMessage() . "\n";
        }
    }

    /**
     * Rollback the migration by dropping the order_items table.
     */
    public function down(): void
    {
        ...
        try {
            ...
            echo "Error dropping table 'order_items': " . $e->getMessage() . "\n";
        }
    }
} 