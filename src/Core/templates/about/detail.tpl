...
#th-manufacturing-process | before = <?php 
    if(isset($current_component)) $previous_component = $current_component;
    $manufacturingprocess = $current_component = $this->_component['manufacturingprocess']?? [];

    echo '<pre>';
    print_r($manufacturingprocess);
    echo '</pre>';
?>
[data-v-component-manufacturingprocess] [data-v-manufacturingprocess-*]|innerText = $manufacturingprocess['@@__data-v-manufacturingprocess-(*)__@@']
    [data-v-component-manufacturingprocess] [data-v-manufacturingprocess-title]|innerHTML = <?php echo $manufacturingprocess['title']; ?>
    [data-v-component-manufacturingprocess] [data-v-manufacturingprocess-description]|innerHTML = <?php echo $manufacturingprocess['description']; ?>
    [data-v-component-manufacturingprocess] [data-v-manufacturingprocess-link_text]|innerHTML = <?php echo $manufacturingprocess['link_text']; ?>
    a[data-v-manufacturingprocess-link] | href = <?php echo isset($manufacturingprocess["link"]) ? '/about' . (strpos($manufacturingprocess["link"], '/') === 0 ? $manufacturingprocess["link"] : '/' . ltrim($manufacturingprocess["link"], '/')) : ''; ?>
[data-v-component-manufacturingprocess] [data-v-manufacturingprocess-image]|src = <?php echo $manufacturingprocess['image']; ?>
...
#th-goverment-supplier | before = <?php 
    if(isset($current_component)) $previous_component = $current_component;
    $governmentsupplier = $current_component = $this->_component['governmentsupplier']?? [];
    // echo '<pre>';
    // print_r($governmentsupplier);
    // echo '</pre>';
?>
div[data-v-governmentsupplier-image_one] | data-bg-src = <?php echo $governmentsupplier['image_one']; ?>
div[data-v-governmentsupplier-image_two] | data-bg-src = <?php echo $governmentsupplier['image_two']; ?>
h2[data-v-governmentsupplier-title_one] | innerHTML = <?php echo $governmentsupplier['title_one']; ?>
h2[data-v-governmentsupplier-title_two] | innerHTML = <?php echo $governmentsupplier['title_two']; ?>
h6[data-v-governmentsupplier-description_one] | innerHTML = <?php echo $governmentsupplier['description_one']; ?>
h6[data-v-governmentsupplier-description_two] | innerHTML = <?php echo $governmentsupplier['description_two']; ?>
a[data-v-governmentsupplier-link_text_one] | innerHTML = <?php echo $governmentsupplier['link_text_one']; ?>
a[data-v-governmentsupplier-link_text_two] | innerHTML = <?php echo $governmentsupplier['link_text_two']; ?>
a[data-v-governmentsupplier-link_one] | href = <?php echo isset($governmentsupplier["link_one"]) ? '/about' . (strpos($governmentsupplier["link_one"], '/') === 0 ? $governmentsupplier["link_one"] : '/' . ltrim($governmentsupplier["link_one"], '/')) : ''; ?>
a[data-v-governmentsupplier-link_two] | href = <?php echo isset($governmentsupplier["link_two"]) ? '/about' . (strpos($governmentsupplier["link_two"], '/') === 0 ? $governmentsupplier["link_two"] : '/' . ltrim($governmentsupplier["link_two"], '/')) : ''; ?>
