...
use App\Core\Components\Virtualshowrooms;
use App\Core\Models\Component\ComponentData;

class VirtualShowroomsComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Virtualshowrooms $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Virtualshowrooms::class);
    }
