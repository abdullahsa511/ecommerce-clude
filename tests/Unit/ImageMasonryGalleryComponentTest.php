...
use App\Core\Components\Imagemasonrygallery;
use App\Core\Models\Component\ComponentData;

class ImageMasonryGalleryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Imagemasonrygallery $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Imagemasonrygallery::class);
    }
