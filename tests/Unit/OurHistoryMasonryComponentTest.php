...
use App\Core\Components\Ourhistorymasonry;
use App\Core\Models\Component\ComponentData;

class OurHistoryMasonryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Ourhistorymasonry $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Ourhistorymasonry::class);
    }
