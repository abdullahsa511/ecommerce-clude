...
use App\Core\Components\Productstorymasonry;
use App\Core\Models\Component\ComponentData;

class ProductStoryMasonryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productstorymasonry $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productstorymasonry::class);
    }
