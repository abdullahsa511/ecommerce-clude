...
use App\Core\Components\Blogmain;
use App\Core\Models\Component\ComponentData;

class BlogMainComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Blogmain $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Blogmain::class);
    }
