...
use App\Core\Components\Productfeature;
use App\Core\Models\Component\ComponentData;

class ProductFeatureComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productfeature $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productfeature::class);
    }
