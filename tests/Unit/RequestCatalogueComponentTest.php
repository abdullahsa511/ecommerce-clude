...
use App\Core\Components\Requestcatalogue;
use App\Core\Models\Component\ComponentData;

class RequestCatalogueComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Requestcatalogue $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Requestcatalogue::class);
    }
