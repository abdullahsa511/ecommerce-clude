...
use App\Core\Components\Instagramslider;
use App\Core\Models\Component\ComponentData;

class InstagramSliderComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Instagramslider $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Instagramslider::class);
    }
