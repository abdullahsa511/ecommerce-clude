...
use App\Core\Components\Featuredmaterialslider;
use App\Core\Models\Component\ComponentData;

class FeaturedMaterialSliderComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Featuredmaterialslider $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Featuredmaterialslider::class);
    }
