...
use App\Core\Components\Productrelatedfamily;
use App\Core\Models\Component\ComponentData;

class ProductRelatedFamilyComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productrelatedfamily $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productrelatedfamily::class);
    }
