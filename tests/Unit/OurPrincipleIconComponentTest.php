...
use App\Core\Components\Ourprincipleicon;
use App\Core\Models\Component\ComponentData;

class OurPrincipleIconComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Ourprincipleicon $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Ourprincipleicon::class);
    }
