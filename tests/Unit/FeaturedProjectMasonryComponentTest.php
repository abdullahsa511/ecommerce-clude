...
use App\Core\Components\Featureprojectsmasonry;
use App\Core\Models\Component\ComponentData;

class FeaturedProjectMasonryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Featureprojectsmasonry $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Featureprojectsmasonry::class);
    }
