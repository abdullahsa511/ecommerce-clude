...
use App\Core\Components\Ourdesignprocess;
use App\Core\Models\Component\ComponentData;

class OurDesignProcessComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Ourdesignprocess $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Ourdesignprocess::class);
    }
