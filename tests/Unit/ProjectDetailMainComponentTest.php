...
use App\Core\Components\Projectdetailmain;
use App\Core\Models\Component\ComponentData;

class ProjectDetailMainComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Projectdetailmain $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Projectdetailmain::class);
    }
