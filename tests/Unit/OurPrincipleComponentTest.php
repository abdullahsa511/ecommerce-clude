...
use App\Core\Components\Ourprinciple;
use App\Core\Models\Component\ComponentData;

class OurPrincipleComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Ourprinciple $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Ourprinciple::class);
    }
