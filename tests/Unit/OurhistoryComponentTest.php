...
use App\Core\Components\Ourhistory;
use App\Core\Models\Component\ComponentData;

class OurhistoryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Ourhistory $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Ourhistory::class);
    }
