...
use App\Core\Components\Categoriesmasonry;
use App\Core\Models\Component\ComponentData;

class CategoriesMasonryComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Categoriesmasonry $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Categoriesmasonry::class);
    }
