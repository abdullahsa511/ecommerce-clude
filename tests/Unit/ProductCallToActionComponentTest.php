...
use App\Core\Components\Productcalltoaction;
use App\Core\Models\Component\ComponentData;

class ProductCallToActionComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productcalltoaction $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productcalltoaction::class);
    }
