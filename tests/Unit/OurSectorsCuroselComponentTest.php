...
use App\Core\Components\Oursectorscurosel;
use App\Core\Models\Component\ComponentData;

class OurSectorsCuroselComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Oursectorscurosel $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Oursectorscurosel::class);
    }
