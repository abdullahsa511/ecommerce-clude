...
use App\Core\Components\Featuredproductslider;
use App\Core\Models\Component\ComponentData;

class FeaturedProductSliderComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Featuredproductslider $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Featuredproductslider::class);
    }
