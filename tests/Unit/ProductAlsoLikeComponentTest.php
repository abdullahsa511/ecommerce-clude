...
use App\Core\Components\Productalsolike;
use App\Core\Models\Component\ComponentData;

class ProductAlsoLikeComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productalsolike $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productalsolike::class);
    }
