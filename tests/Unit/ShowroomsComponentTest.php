...
use App\Core\Components\Showrooms;
use App\Core\Models\Component\ComponentData;

class ShowroomsComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Showrooms $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Showrooms::class);
    }
