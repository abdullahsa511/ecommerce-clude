...
use App\Core\Components\Governmentsupplier;
use App\Core\Models\Component\ComponentData;

class GovernmentsupplierComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Governmentsupplier $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Governmentsupplier::class);
    }
