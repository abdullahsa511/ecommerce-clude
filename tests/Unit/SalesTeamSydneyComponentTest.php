...
use App\Core\Components\Salesteamsydneys;
use App\Core\Models\Component\ComponentData;

class SalesTeamSydneyComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Salesteamsydneys $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Salesteamsydneys::class);
    }
