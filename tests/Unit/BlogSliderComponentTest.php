...
use App\Core\Components\Blogslider;
use App\Core\Models\Component\ComponentData;

class BlogSliderComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Blogslider $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Blogslider::class);
    }
