...
use App\Core\Components\Manufacturingprocess;
use App\Core\Models\Component\ComponentData;

class ManufacturingProcessComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Manufacturingprocess $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Manufacturingprocess::class);
    }
