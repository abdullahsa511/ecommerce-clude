...
use App\Core\Components\Productsustainablity;
use App\Core\Models\Component\ComponentData;

class ProductSustainablityComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productsustainablity $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productsustainablity::class);
    }
