...
use App\Core\Components\Productslider;
use App\Core\Models\Component\ComponentData;

class ProductSliderComponentTest extends TestCase
{
    private KernelCli $kernel;
    private Container $container;
    private Productslider $component;
    ...
    protected function setUp(): void
    {
        ...
        $this->component = $this->container->make(Productslider::class);
    }
